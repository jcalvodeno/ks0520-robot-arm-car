...
void setup(){
  ...
  myservo2.attach(A0);  //0~120---100,servo 2, left servo is connected to A0
  myservo3.attach(8); //75~180---80,servo 3, right servo is connected to D8
  myservo4.attach(9); //18~180---90, servo 4, servo on claw is connected to D9
  delay(1000);
